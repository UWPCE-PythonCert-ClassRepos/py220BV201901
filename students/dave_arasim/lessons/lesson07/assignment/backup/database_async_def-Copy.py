...
async def import_products_data(data_dir, products_file):
    """ Load MongoDB database products collection from .csv file """
    print('inside import_products_data\n') # DKA
    await asyncio.sleep(0) # DKA
    mongo = MongoDBConnection()
    ...
    print('done with import_products_data\n') # DKA
    return added, errors, elapsed


async def import_customers_data(data_dir, customers_file):
    """ Load MongoDB database customers collection from .csv file """
    print('inside import_customers_data\n') # DKA
    await asyncio.sleep(0) # DKA
    mongo = MongoDBConnection()
    ...
    print('done with import_customers_data\n') # DKA
    return added, errors, elapsed


async def import_rentals_data(data_dir, rentals_file):
    """ Load MongoDB database rentals collection from .csv file """
    print('inside import_rentals_data\n') # DKA
    await asyncio.sleep(0) # DKA
    mongo = MongoDBConnection()
    ...
    print('done with import_rentals_data\n') # DKA
    return added, errors, elapsed
